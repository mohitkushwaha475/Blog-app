...
export const Footer = () => {
  return (
    <div className="shadow footermanual" >
      <CDBBox
        display="flex"
        ...
        <CDBBox display="flex" alignItems="center">
          <a href="/" className="d-flex align-items-center p-0 text-dark">
            <img
              ...
              width="30px"
            />
            <span className="ms-4 h5 mb-0 font-weight-bold">MyBlogs</span>
          </a>
          <small className="ms-2">&copy; MyBlogs, 2023. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex">
